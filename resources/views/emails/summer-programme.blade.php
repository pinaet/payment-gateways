...
<body>
    <table id="bank" width="700" align="center" style="margin-top: 30px">
        ...
        <tr>
            <td class="left-col" style="background-color:#001844; color:#a39163; padding-left:10px;">Reference ID</td>
            <td colsapn="3" class="right-col" style="background-color:#FDF8EF; color:#000000; padding-left:10px;">{{ $order['reference_order'] }}</td>
        </tr>
        <tr>
            <td class="left-col" style="background-color:#001844; color:#a39163; padding-left:10px;">Total Amount (include service fee)</td>
        ...
        <tr>
            <td colspan="2">
            <br/>
                {{-- <b>We have received your payment of {{ $endpoint['name'] }}.</b><br/>
                <b>Should you have any urgent requests please contact <br><span style="color:#A39163">holidayprogrammes@harrowschool.ac.th</span>.</b><br/> --}}
                <b>{{ $endpoint['footnote'] }}</b>
            </td>
        </tr>
        <tr>
            <td colspan="2"><hr width="700px"></td>
